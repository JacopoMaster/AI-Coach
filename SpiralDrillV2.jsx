...
const TIERS = [
  ...
  { id: 2, minLevel: 5, label: "Polished Steel",
  ...
  { id: 3, minLevel: 15, label: "Bronze Awakening",
  ...
  { id: 4, minLevel: 30, label: "Golden Fury",
  ...
  { id: 5, minLevel: 50, label: "Crimson Gold",
  ...
  { id: 6, minLevel: 70, label: "Inferno Core",
  ...
  { id: 7, minLevel: 85, label: "Void Piercer",
  ...
  { id: 8, minLevel: 95, label: "Lightning Drill",
  ...
  { id: 9, minLevel: 99, label: "Critical Mass",
  ...
  { id: 10, minLevel: 100, label: "PIERCE THE HEAVENS",
  ...
  { id: 11, minLevel: 150, label: "SUPER TENGEN TOPPA",
