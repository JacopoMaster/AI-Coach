...
const TIERS: Tier[] = [
  ...
  { id: 2, minLevel: 15, label: "Polished Steel",
  ...
  { id: 3, minLevel: 30, label: "Bronze Awakening",
  ...
  { id: 4, minLevel: 50, label: "Golden Fury",
  ...
  { id: 5, minLevel: 70, label: "Crimson Gold",
  ...
  { id: 6, minLevel: 90, label: "Inferno Core",
  ...
  { id: 7, minLevel: 100, label: "Void Piercer",
  ...
  { id: 8, minLevel: 125, label: "Lightning Drill",
  ...
  { id: 9, minLevel: 150, label: "Critical Mass",
  ...
  { id: 10, minLevel: 175, label: "PIERCE THE HEAVENS",
  ...
  { id: 11, minLevel: 200, label: "SUPER TENGEN TOPPA",
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes tip-orbit-b {
          from { transform: rotate(90deg) translateX(32px) rotate(-90deg); }
          to   { transform: rotate(450deg) translateX(32px) rotate(-450deg); }
        }
        @keyframes tip-orbit-c {
          from { transform: rotate(180deg) translateX(26px) rotate(-180deg); }
          to   { transform: rotate(-180deg) translateX(26px) rotate(180deg); }
        }
        @keyframes tip-orbit-d {
          from { transform: rotate(270deg) translateX(38px) rotate(-270deg); }
          to   { transform: rotate(-90deg) translateX(38px) rotate(90deg); }
        }
        .tip-orbit-a { animation: tip-orbit-a 3s linear infinite; }
        .tip-orbit-b { animation: tip-orbit-b 4.5s linear infinite; }
        .tip-orbit-c { animation: tip-orbit-c 2.5s linear infinite; }
      ...
      >
        ...
        >
          ...
          {tier.tipGlow && (
            <>
              {/* Stella centrale sulla punta — unico elemento "apicale".
                  Dimensione scala col tier: più la trivella è potente, più la
                  stella di punta si ingrandisce. */}
              <g style={{ transformOrigin: `${CX}px ${TIP_Y}px` }} className="tip-star">
                <CrossStar
                  cx={CX}
                  cy={TIP_Y}
                  size={
              ...
              {tier.id >= 7 && (
                <g style={{ transformOrigin: `${CX}px ${TIP_Y}px` }}>
                  <g style={{ transformOrigin: `${CX}px ${TIP_Y}px` }} className="tip-orbit-a">
                    <CrossStar cx={CX} cy={TIP_Y} size={tier.megaForm ? 6 : 4} color="#fff4a3" delay={0} duration={1.2} />
                  </g>
                  <g style={{ transformOrigin: `${CX}px ${TIP_Y}px` }} className="tip-orbit-b">
                    <CrossStar cx={CX} cy={TIP_Y} size={tier.megaForm ? 5 : 3} color="#ffffff" delay={0.3} duration={1.4} />
                  </g>
                </g>
              )}
              ...
              {tier.id >= 9 && (
                <g style={{ transformOrigin: `${CX}px ${TIP_Y}px` }}>
                  <g style={{ transformOrigin: `${CX}px ${TIP_Y}px` }} className="tip-orbit-c">
                    <CrossStar cx={CX} cy={TIP_Y} size={tier.megaForm ? 7 : 5} color="#fff080" delay={0.1} duration={1} />
                  </g>
                  <g style={{ transformOrigin: `${CX}px ${TIP_Y}px` }} className="tip-orbit-d">
                    <CrossStar cx={CX} cy={TIP_Y} size={tier.megaForm ? 8 : 4} color="#ffffff" delay={0.5} duration={1.3} />
                  </g>
                </g>
              )}
            </>
