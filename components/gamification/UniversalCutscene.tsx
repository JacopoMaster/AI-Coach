...
const TIERS: Tier[] = [
  ...
  { id: 2, minLevel: 15, label: 'Polished Steel', bodyGrad: 'steel-bright', grooveBase: '#0a0a0a', grooveMid: '#8a8a8a', grooveHi: '#ffffff', rim: '#3a3a3a', tipGlow: '#d0e8ff', speed: 0.55, aura: { color: '#c8d8f0', opacity: 0.25, size: 1.05 }, crossStars: 0, particles: 0, rays: 0, shockRing: false, lightning: false, cosmic: false, megaForm: false, shadowColor: null, sparkColor: '#d0e8ff' },
  { id: 3, minLevel: 30, label: 'Bronze Awakening', bodyGrad: 'bronze', grooveBase: '#3a1e00', grooveMid: '#c07820', grooveHi: '#ffd080', rim: '#5a2f08', tipGlow: '#ffa040', speed: 0.5, aura: { color: '#ff9040', opacity: 0.35, size: 1.12 }, crossStars: 1, particles: 3, rays: 0, shockRing: false, lightning: false, cosmic: false, megaForm: false, shadowColor: 'rgba(255, 144, 64, 0.45)', sparkColor: '#ffa040' },
  { id: 4, minLevel: 50, label: 'Golden Fury', bodyGrad: 'gold', grooveBase: '#6b4a00', grooveMid: '#d4a017', grooveHi: '#fff4a3', rim: '#8b6508', tipGlow: '#fff080', speed: 0.45, aura: { color: '#ffcc40', opacity: 0.45, size: 1.18 }, crossStars: 2, particles: 6, rays: 4, shockRing: false, lightning: false, cosmic: false, megaForm: false, shadowColor: 'rgba(255, 204, 64, 0.6)', sparkColor: '#fff080' },
  { id: 5, minLevel: 70, label: 'Crimson Gold', bodyGrad: 'crimson-gold', grooveBase: '#4a0a00', grooveMid: '#e04010', grooveHi: '#ffd060', rim: '#8b0508', tipGlow: '#ff6020', speed: 0.38, aura: { color: '#ff4020', opacity: 0.55, size: 1.25 }, crossStars: 4, particles: 10, rays: 6, shockRing: true, lightning: false, cosmic: false, megaForm: false, shadowColor: 'rgba(255, 64, 32, 0.65)', sparkColor: '#ff6020' },
  { id: 6, minLevel: 90, label: 'Inferno Core', bodyGrad: 'inferno', grooveBase: '#2a0000', grooveMid: '#ff1020', grooveHi: '#ffe040', rim: '#5a0008', tipGlow: '#ff2000', speed: 0.32, aura: { color: '#ff1040', opacity: 0.65, size: 1.32 }, crossStars: 6, particles: 14, rays: 8, shockRing: true, lightning: false, cosmic: false, megaForm: false, shadowColor: 'rgba(255, 32, 0, 0.75)', sparkColor: '#ff2000' },
  { id: 7, minLevel: 100, label: 'Void Piercer', bodyGrad: 'violet', grooveBase: '#1a0030', grooveMid: '#c020ff', grooveHi: '#ffa0ff', rim: '#3a0050', tipGlow: '#ff40ff', speed: 0.28, aura: { color: '#d040ff', opacity: 0.7, size: 1.4 }, crossStars: 7, particles: 18, rays: 10, shockRing: true, lightning: false, cosmic: false, megaForm: false, shadowColor: 'rgba(208, 64, 255, 0.8)', sparkColor: '#ff40ff' },
  { id: 8, minLevel: 125, label: 'Lightning Drill', bodyGrad: 'lightning', grooveBase: '#001830', grooveMid: '#00d0ff', grooveHi: '#e0ffff', rim: '#003050', tipGlow: '#00ffff', speed: 0.22, aura: { color: '#00d0ff', opacity: 0.8, size: 1.48 }, crossStars: 8, particles: 22, rays: 12, shockRing: true, lightning: true, cosmic: false, megaForm: false, shadowColor: 'rgba(0, 208, 255, 0.9)', sparkColor: '#00ffff' },
  { id: 9, minLevel: 150, label: 'Critical Mass', bodyGrad: 'white-hot', grooveBase: '#402020', grooveMid: '#ffffff', grooveHi: '#ffffff', rim: '#606060', tipGlow: '#ffffff', speed: 0.16, aura: { color: '#ffffff', opacity: 0.95, size: 1.58 }, crossStars: 10, particles: 28, rays: 16, shockRing: true, lightning: true, cosmic: false, megaForm: false, shadowColor: 'rgba(255, 255, 255, 1)', sparkColor: '#ffffff' },
  { id: 10, minLevel: 175, label: 'PIERCE THE HEAVENS', bodyGrad: 'cosmic', grooveBase: '#000020', grooveMid: '#ff00ff', grooveHi: '#ffff00', rim: '#4000a0', tipGlow: '#ffffff', speed: 0.1, aura: { color: '#ff00ff', opacity: 1, size: 1.7 }, crossStars: 12, particles: 40, rays: 20, shockRing: true, lightning: true, cosmic: true, megaForm: false, shadowColor: 'rgba(255, 0, 255, 1)', sparkColor: '#ff00ff' },
  { id: 11, minLevel: 200, label: 'SUPER TENGEN TOPPA', bodyGrad: 'galaxy', grooveBase: '#ffffff', grooveMid: '#ffffff', grooveHi: '#ffffff', rim: '#ffffff', tipGlow: '#ffffff', speed: 0.06, aura: { color: '#ffffff', opacity: 1, size: 2.0 }, crossStars: 16, particles: 60, rays: 32, shockRing: true, lightning: true, cosmic: true, megaForm: true, shadowColor: 'rgba(255, 255, 255, 1)', sparkColor: '#fff080' },
]
